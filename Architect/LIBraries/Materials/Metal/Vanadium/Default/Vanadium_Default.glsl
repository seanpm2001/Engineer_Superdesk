...
* Chemical element symbol: V
* Atomic number: 23
* Phase: solid
* Rare: true
* Related: Metal, Chromium (can be easily confused with chromium)
* Melting point (Kelvin): 2183
* Melting point (Celsius): 1910
* Melting point (Fahrenheit): 3470
* Boiling point (Kelvin): 3680
* Boiling point (Celsius): 3407
* Boiling point (Fahrenheit): 6165
* Alloy: true
*/
...
* File version: 1 (2022, Thursday, April 7th at 6:26 pm)
