...
* Chromium (Default)
* Categories: metal, vanadium, chromium, elements, metal alloy, earth
* Flammable: yes
* Renewable: no
* Chemical element: true
* Chemical element symbol: Cr
* Atomic number: 24
* Phase: solid
* Rare: true
* Related: Metal, Vanadium (can be easily confused with chromium)
* Melting point (Kelvin): 2180
* Melting point (Celsius): 1907
* Melting point (Fahrenheit): 3465
* Boiling point (Kelvin): 2944
* Boiling point (Celsius): 2671
* Boiling point (Fahrenheit): 4840
* Alloy: true
*/
...
* File version: 1 (2022, Thursday, April 7th at 6:31 pm)
