...
* Manganese (Default)
* Categories: metal, manganese, elements, metal alloy, earth
* Flammable: yes
* Renewable: no
* Chemical element: true
* Chemical element symbol: Mn
* Atomic number: 25
* Phase: solid
* Rare: true
* Related: Metal, Magnesium (do not confuse the names)
* Melting point (Kelvin): 1519
* Melting point (Celsius): 1246
* Melting point (Fahrenheit): 2275
* Boiling point (Kelvin): 2334
* Boiling point (Celsius): 2061
* Boiling point (Fahrenheit): 3742
* Alloy: true
*/
...
void manganese_default_Texture()
{
  // Not available yet
}
#endif
...
* File version: 1 (2022, Thursday, April 7th at 6:35 pm)
