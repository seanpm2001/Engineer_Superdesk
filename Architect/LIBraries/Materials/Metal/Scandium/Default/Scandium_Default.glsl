...
* Scandium (Default)
* Categories: metal, scandium, elements, metal alloy, earth
* Flammable: yes
* Renewable: no
* Chemical element: true
* Chemical element symbol: Sc
* Atomic number: 21
* Phase: solid
* Rare: false
* Related: Metal
* Melting point (Kelvin): 1814
* Melting point (Celsius): 1541
* Melting point (Fahrenheit): 2806
* Boiling point (Kelvin): 3109
* Boiling point (Celsius): 2836
* Boiling point (Fahrenheit): 5136
* Alloy: true
*/
...
* File version: 1 (2022, Thursday, April 7th at 6:12 pm)
