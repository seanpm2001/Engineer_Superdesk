...
* Cobalt (Default)
* Categories: metal, cobalt, elements, earth
* Flammable: yes
* Renewable: no
* Chemical element: true
* Chemical element symbol: Co
* Atomic number: 27
* Phase: solid
* Rare: somewhat
* Related: Nickel
* Melting point (Kelvin): 1768
* Melting point (Celsius): 1495
* Melting point (Fahrenheit): 2723
*/
...
* File version: 1 (2022, Wednesday, April 6th at 5:54 pm)
