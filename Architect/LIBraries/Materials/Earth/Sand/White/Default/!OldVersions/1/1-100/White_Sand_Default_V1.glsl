...
* White sand (Default)
* Categories: sand, natural, earth, beach, crushed, crush, white, grain
* Flammable: no
* Renewable: no
...
* Phase: solid
* Rare: no
* Related: other types of sand, gravel
* Type: Sand (white)
...
void white_sand_default_Texture()
{
  // Not available yet
}
#endif
...
* File version: 1 (2022, Wednesday, April 6th at 6:08 pm)
